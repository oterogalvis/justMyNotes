package com.treehouse.math;

import com.treehouse.docgen.Doc;
...
public class MathUtils {
    ...
    @Doc(desc = "Calculates the area of a triangle",
    ...
    @Doc(desc = "Claculates the distance between the given points",
